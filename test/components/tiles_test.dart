...
main() {
  ...
  Proposal proposal = Proposal(dateTime: DateTime(2023, 6, 15, 15, 40, 43), owner: user, place: place0, type: 'Friends', participants: []);
  ...
  testWidgets('Proposal tile', (tester) async {
    await tester.pumpWidget(MediaQuery(
        ...
        child: Builder(builder: (BuildContext context) {
          return MaterialApp(
              home: Scaffold(body: ProposalTile.fromProposal(proposal, context)));
        })));
    final titleFinder = find.text('Parco Suardi');
